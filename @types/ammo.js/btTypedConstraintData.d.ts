declare module Ammo {
  declare class btTypedConstraintData {
    get_m_rbA(): btRigidBodyData;	set_m_rbA(value: btRigidBodyData): btRigidBodyData;
    get_m_rbB(): btRigidBodyData;	set_m_rbB(value: btRigidBodyData): btRigidBodyData;
