declare module Ammo {
  declare class btCompoundLeafCallback {
    constructor(compoundObjWrap: btCollisionObjectWrapper, otherObjWrap: btCollisionObjectWrapper, dispatcher: btDispatcher, dispatchInfo: btDispatcherInfo, resultOut: btManifoldResult, m: btCollisionAlgorith, s: childCollisionAlgorithm, sharedManifold: btPersistentManifold);
