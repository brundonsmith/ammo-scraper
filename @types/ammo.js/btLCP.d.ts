declare module Ammo {
  declare class btLCP {
    constructor(_n: number, _nskip: number, _nub: number, _Adata: number, _x: number, _b: number, _w: number, _lo: number, _hi: number, l: number, _d: number, _Dell: number, _ell: number, _tmp: number, _state: boolean, _findex: number, p: number, c: number, r: btScala, s: Arow);
    getNub(): number;
