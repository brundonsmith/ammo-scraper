declare module Ammo {
  declare class Bullet_btCollisionObjectFloatData {
    ...
    get_m_interpolationWorldTransform(): btTransformFloatData;	set_m_interpolationWorldTransform(value: btTransformFloatData): btTransformFloatData;
    get_m_interpolationLinearVelocity(): btVector3FloatData;	set_m_interpolationLinearVelocity(value: btVector3FloatData): btVector3FloatData;
    get_m_interpolationAngularVelocity(): btVector3FloatData;	set_m_interpolationAngularVelocity(value: btVector3FloatData): btVector3FloatData;
    get_m_anisotropicFriction(): btVector3FloatData;	set_m_anisotropicFriction(value: btVector3FloatData): btVector3FloatData;
